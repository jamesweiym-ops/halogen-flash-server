...
# The pristine 0.11.1 front-end this patch was written against. It is the
# merge base: the 3-way merge needs it to tell "my change" from "upstream's
# change". Saved alongside the patch so the rebase never depends on the
# running container.
BASE_PRISTINE = os.environ.get("REPORT_BASE", "/home/james/halogen-serve/pristine-0.11.1.py")
