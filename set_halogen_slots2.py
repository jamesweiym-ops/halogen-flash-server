...
staged = "halogen-flash-server-slots2-staged"
backup = "halogen-flash-server-before-slots2-20260915"
...
config["Env"] = replace_env(config["Env"], "HALOGEN_KV_SLOTS=", "HALOGEN_KV_SLOTS=2")
...
print(f"Started two-slot rollout; rollback container: {backup}")
